...
<body>
    ...
    <div class="menu">
        <ul>
            ...
            <li><a href="home.php" class="meumenu" title="Home">Home</a></li>
            <li><a href="calendario.php" class="meumenu" title="Calendario">Calendario</a></li>
            <li><a href="produto.php" class="meumenu" title="Produtos">Nossa Horta</a></li>
            <li><a href="logout.php" class="meumenu" title="Logout">Logout</a></li>
        </ul>
    </div>
    <div class="container">
        <hr>
